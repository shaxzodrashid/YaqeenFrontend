...
```json
{
  ...
  "summary": {
    "totalSales": 48500.00,
    "totalPurchaseCost": 32100.00,
    "totalMargin": 16400.00,
  ...
  "dataPoints": [
    ...
    },
    {
      ...
      "margin": 1500.00,
      "orderCount": 2,
      "cumulativeSales": 48500.00,
      "cumulativeMargin": 16400.00
    }
  ]
}
```
...
export const SalesProgressChart = ({ period = '1M' }) => {
  ...
  return (
    <div>
      <h3>Sales Progress ({summary?.growthRateSales ? `+${summary.growthRateSales}%` : ''})</h3>
      <ResponsiveContainer width="100%" height={350}>
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="sales" stroke="#2563eb" name="Sales Revenue" strokeWidth={2} />
          <Line type="monotone" dataKey="cumulativeSales" stroke="#10b981" name="Cumulative Sales" strokeDasharray="5 5" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
