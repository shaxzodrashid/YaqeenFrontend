...
export const CargoDistributionCharts: React.FC<CargoDistributionChartsProps> = React.memo(({ data, loading }) => {
      ...
      <div className="p-5 rounded-2xl bg-surface dark:bg-night-surface border border-border/60 dark:border-night-border shadow-xs flex flex-col justify-between transition-colors duration-300">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-sm font-bold text-foreground dark:text-night-text"><T k="ovDistByCargoType" /></h4>
          </div>
        ...
        <div className="flex items-center justify-between my-4 gap-4">
          ...
          <div className="relative shrink-0">
            <svg width={140} height={140} viewBox="0 0 140 140" className="overflow-visible select-none">
                ...
                >
                  <div className="flex items-center justify-between text-xs font-bold">
                    <div className="flex items-center gap-1.5 truncate">
                      ...
                      <span className="text-foreground dark:text-night-text truncate">{item.category}</span>
                    </div>
      ...
      <div className="p-5 rounded-2xl bg-surface dark:bg-night-surface border border-border/60 dark:border-night-border shadow-xs flex flex-col justify-between transition-colors duration-300">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-sm font-bold text-foreground dark:text-night-text"><T k="ovDistByStatus" /></h4>
          </div>
