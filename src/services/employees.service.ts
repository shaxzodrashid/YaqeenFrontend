...
export const demoEmployeesDb: Map<string, Employee> = new Map([
  ...
  [
    '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d',
    {
      ...
      is_active: true,
      total_assigned_employees: 2,
      total_revenue: { USD: 7200, UZS: 0, RUB: 0 },
      plan_completion: { ltl_completion: 100, ftl_completion: 100 },
      tushum: { amount: 7200, currency: 'USD', formatted: '$7,200' },
      reja_fakt: {
        plan_target: 7000,
        fact_amount: 7200,
        percentage: 102.8,
        ...
        status: 'Bajarildi',
        status_code: 'COMPLETED',
        formatted_plan: '$7,000',
        formatted_fact: '$7,200',
      },
      mijozlar_count: 16,
  ...
  [
    'a2c3d4e5-f6a7-8901-bcde-f23456789012',
    {
      id: 'a2c3d4e5-f6a7-8901-bcde-f23456789012',
      first_name: 'Alisher',
      last_name: 'Sodikov',
      full_name: 'Alisher Sodikov',
      phone: '+998902345678',
      secondary_phone: null,
      address: 'Tashkent, Uzbekistan',
      department_id: '07d223ca-4167-47f7-a929-61d47a3628a7',
      ...
      is_active: true,
      total_assigned_employees: 0,
      total_revenue: { USD: 3200, UZS: 0, RUB: 0 },
      plan_completion: { ltl_completion: 64, ftl_completion: 64 },
      tushum: { amount: 3200, currency: 'USD', formatted: '$3,200' },
      reja_fakt: {
        plan_target: 5000,
        fact_amount: 3200,
        percentage: 64.0,
        ...
        status: 'Bajarilmoqda',
        status_code: 'IN_PROGRESS',
        formatted_plan: '$5,000',
        formatted_fact: '$3,200',
      },
      mijozlar_count: 8,
      created_at: '2026-07-20T10:00:00.000Z',
      updated_at: '2026-07-20T10:00:00.000Z',
  ...
  [
    'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
    {
      ...
      department_name: 'sales',
      department_display_name: 'Sales HQ',
      role_name: 'Junior Sales Manager',
      user_role: 'EMPLOYEE',
      user_status: 'Open',
      status: 'Open',
      fixed_salary: '250.00',
      ...
      is_active: true,
      total_assigned_employees: 0,
      total_revenue: { USD: 2500, UZS: 0, RUB: 0 },
      plan_completion: { ltl_completion: 83.3, ftl_completion: 83.3 },
      tushum: { amount: 2500, currency: 'USD', formatted: '$2,500' },
      reja_fakt: {
        plan_target: 3000,
        fact_amount: 2500,
        percentage: 83.3,
        ...
        status: 'Bajarildi',
        status_code: 'COMPLETED',
        formatted_plan: '$3,000',
        formatted_fact: '$2,500',
      },
      mijozlar_count: 10,
      created_at: '2026-07-20T10:00:00.000Z',
      updated_at: '2026-07-20T10:00:00.000Z',
